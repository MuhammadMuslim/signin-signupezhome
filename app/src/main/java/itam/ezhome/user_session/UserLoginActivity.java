package itam.ezhome.user_session;
...
import itam.ezhome.menu.mainpage;
import itam.ezhome.volley.HttpParse;
...
public class UserLoginActivity extends AppCompatActivity {
    ...
    String finalResult ;
    String HttpURL = "https://muslimalfathih19.000webhostapp.com/ezhome/UserLogin.php";
        ...
        class UserLoginClass extends AsyncTask<String,Void,String> {
            ...
            protected void onPostExecute(String httpResponseMsg) {
                ...
                if(httpResponseMsg.equalsIgnoreCase("Data Matched")){
                    ...
                    Intent intent = new Intent(UserLoginActivity.this, mainpage.class);
